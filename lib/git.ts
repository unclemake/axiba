...
var git = new class Git {
    ...
    * @param  longName 远程分支
    */
    push(name?: string, longName?: string): Promise<string> {
        var t = this;
    ...
    * @param  name 分支名称
    */
    checkout(name?: string): Promise<string> {
        name = name || 'master';
    ...
    * @param  end 日记id
    */
    getLogDiff(start?: string, end?: string): Promise<string[]> {
    ...
    */
    ...
    /**
      ...
      * @param {string} start 项目起点
       */
    saveStartPointId(start?: any): Promise<any> {
        var t = this;
