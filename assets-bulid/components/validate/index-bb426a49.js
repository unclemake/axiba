define("components/validate/index-bb426a49.js",function(require, exports, module) {
"use strict";
...
var index_1 = require('../input/index-7a03b33a.js');
var rule_1 = require('./rule-8ffe4ee3.js');
exports.addRule = rule_1.addRule;
exports.getLength = rule_1.getLength;
var index_2 = require('../popover/index-47258ce8.js');
;
;
/**
 * 验证类
...
var Validate = function (_React$Component) {
    ...
    function Validate() {
         ...
         * @memberOf Validate
         */
        var _this = _possibleConstructorReturn(this, (Validate.__proto__ || Object.getPrototypeOf(Validate)).apply(this, arguments));
