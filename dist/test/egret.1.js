define("test/egret.1.js",[],function(require, exports, module) {
class Main extends egret.DisplayObjectContainer {
    ...
    initGraphics() {
        ...
        // this.newWire([{ x: 60, y: 50 }, { x: 90, y: 25 }]);
        // 三条线
    ...
    animation() {
        this.addEventListener(egret.Event.ENTER_FRAME, (evt) => {
            ...
            if (pass > 500) {
                ...
                if (this.deviationLength < this.dashLength) {
                    this.deviationLength++;
                }
                else {
                    this.deviationLength = -this.dashLength;
                }
                this.draw();
            }
        }, this);
...
//# sourceMappingURL=egret.1.js.map
